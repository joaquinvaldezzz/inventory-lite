 ...
 *
 * @returns The password reset form page
 */
export default function ResetPasswordUsernamePassword() {
          ...
          <div className="space-y-8 px-4">
            <div className="space-y-6">
              ...
              <div className="space-y-2 text-center">
                <h1 className="text-2xl font-semibold">I forgot my username and password</h1>
                <p className="text-muted-foreground">
                  Enter your email address you used to register below to reset your username and
                  password.
                </p>
              </div>
            </div>
